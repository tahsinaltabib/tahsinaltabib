...
<p align="left">I'm a passionate <strong>Front-End Developer</strong> from Bangladesh 🇧🇩, currently enrolled in a <strong>Full Stack Web Development</strong> diploma program. I love building clean, responsive, and user-friendly web applications.<br><br>✅ <strong>Completed:</strong> HTML5, CSS3, Bootstrap, Tailwind CSS, JavaScript (ES6+), React.js, TypeScript, Next.js<br>🌱 <strong>Currently Learning:</strong> Node.js, Express.js, MongoDB, MySQL & Full Backend Development<br>🎯 <strong>Goal:</strong> Become a job-ready Full Stack Developer</p>
...
[![Frontend Skills](https://skillicons.dev/icons?i=html,css,bootstrap,tailwind,js,react,ts,nextjs&perline=8)](https://skillicons.dev)

### 🌱 Currently Learning — Backend

[![Backend Skills](https://skillicons.dev/icons?i=nodejs,express,mongodb,mysql,gcp&perline=8)](https://skillicons.dev)

### 🧰 Tools

[![Tools](https://skillicons.dev/icons?i=git,github,vscode,figma,postman,vercel,netlify&perline=8)](https://skillicons.dev)
